    ...
    >
      ...
      >
        ...
        <div className="w-1/2 px-12 py-10 flex flex-col justify-center">
          <h2 className="st-login-header mb-4 text-2xl font-bold text-center text-gray-400">
            Student Login
          </h2>
          <form className="mt-[10px] h-[100%]" onSubmit={handleSubmit}>
            <div className="mb-4">
              <input
                type="email"
                placeholder="Email"
            ...
            <button
              type="submit"
              className="login-btn mt-3 w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600 transition duration-300"
            >
              Login
            </button>
      ...
      <div className={`md:hidden ${styles.loginBox} text-white`}>
        <div className={styles.imageContainer}>
          <img src="/images/side1.png" alt="Login Illustration" />
        </div>
